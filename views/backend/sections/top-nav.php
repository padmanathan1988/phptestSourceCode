            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span><?php  $user_account = $this->session->userdata('user_account');
        echo $user_account[0]['user_name']; ?><i class="caret"></i></span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a class="btn btn-primary btn-flat" href="<?php echo base_url(); ?>backend/admin/profile"><?php echo  "Team" ?></a>
